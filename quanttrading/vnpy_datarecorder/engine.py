...
from constant import EVENT_TICK, EVENT_CONTRACT, EVENT_TIMER
from utility import load_json, save_json, BarGenerator
from database import BaseDatabase, get_database, DB_TZ
...
class RecorderEngine(BaseEngine):
    ...
    def update_tick(self, tick: TickData) -> None:
        ...
        if tick.symbol in self.bar_recordings:
