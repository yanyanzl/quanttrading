...
from ordermanagement import BaseManagement as BaseEngine, MainEngine, EventEngine
from constant import Interval, Exchange
from datatypes import BarData, TickData, ContractData, HistoryRequest
from database import BaseDatabase, get_database, BarOverview, DB_TZ
...
class ManagerEngine(BaseEngine):
    ...
    def download_bar_data(
        ...
        print(f"here in download_bar_data in datamanager engine.{symbol=}")
